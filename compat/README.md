...
| `fixtures/` | licensed upstream fixtures and rust-db-authored ones, kept apart so their licences do not mix |
...
cargo run -p rustdb-compat --bin rustdb-manifest -- report  # generate the report from them
```
