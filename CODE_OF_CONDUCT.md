...
Be decent to people. Argue about code, not about the person who wrote it.
...
This applies to issues, pull requests, discussions, commit messages, code
comments and anywhere somebody is representing the project.

## If something goes wrong

Report it through GitHub's private vulnerability reporting on this repository, or
by opening an issue asking for a private channel without the details in it.
Reports are read by the maintainers and are not shared further.

A first response within **five working days**. What happens after that depends on
what happened, and ranges from a private word to a permanent ban; whoever is
handling the report will say which and why. Somebody who is the subject of a
report does not handle it.
