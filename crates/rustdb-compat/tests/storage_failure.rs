...
use rustdb_storage::pager::{FailSite, NewDatabase, Pager, PagerOptions};
use rustdb_storage::vacuum;
...
type Statement = fn(&mut Pager, PageId) -> Result<(), rustdb_base::DbError>;
...
fn insert_many(pager: &mut Pager, root: PageId) -> Result<(), rustdb_base::DbError> {
...
fn delete_many(pager: &mut Pager, root: PageId) -> Result<(), rustdb_base::DbError> {
...
fn replace_many(pager: &mut Pager, root: PageId) -> Result<(), rustdb_base::DbError> {
    for key in 1..=30i64 {
...
fn vacuum_some(pager: &mut Pager, root: PageId) -> Result<(), rustdb_base::DbError> {
...
fn clear_tree(pager: &mut Pager, root: PageId) -> Result<(), rustdb_base::DbError> {
