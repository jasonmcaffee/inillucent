...
//!
//! Usage: `cargo run --release -p rustdb-compat --bin rustdb-hotprofile`
...
unsafe impl GlobalAlloc for CountingAllocator {
    ...
    unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
        ...
        rustdb_base::probe::ALLOCATIONS.fetch_add(1, Ordering::Relaxed);
...
fn opcode_name(slot: usize) -> String {
    rustdb_vm::Opcode::from_index(slot)
