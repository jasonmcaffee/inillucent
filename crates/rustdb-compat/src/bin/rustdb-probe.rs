//! A diagnostic shell: run SQL against rust-db and print what it says.
//!
...
//! that rust-db failed, this is how the reason is found.
//!
//! It is a harness tool rather than a shell. The real one is `rustdb-cli`; this
...
fn run(connection: &rustdb_session::connection::Connection, statement: &str) {
    match rustdb_session::statement::Statement::prepare(connection, statement.as_bytes()) {
