...
//! rust-db against SQLite's answers, because the answers are in the file rather
...
pub fn render_value(value: &rustdb_value::Value<'_>, letter: char) -> String {
...
fn text_of(value: &rustdb_value::Value<'_>) -> String {
    use rustdb_value::Value;
    match value {
...
pub fn type_letter(value: &rustdb_value::Value<'_>) -> char {
    use rustdb_value::Value;
    match value {
        Value::Integer(_) => 'I',
        Value::Real(_) => 'R',
