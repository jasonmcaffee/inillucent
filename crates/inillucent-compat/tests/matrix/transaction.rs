//! The `transaction` family of the statement matrix, at the cadence of every change.
//!
...
inillucent_compat::matrix_family!(transaction, Change, [g0, g1, g2, g3, g4, g5, g6, g7]);
