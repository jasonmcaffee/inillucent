//! The `tooling` tier of `inillucent-compat`'s integration tests.
//!
//! What the tier is for: the checks that keep the repository's own rules true.
//!
...
//! with `name = "tooling"` and `module = "<file>"` in
