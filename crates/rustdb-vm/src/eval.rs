//! SQLite's arithmetic, comparison and three-valued logic, re-exported from where they now live.
//!
//! Invariant: there is one implementation of each of these in the workspace.
//! They moved down into `rustdb-scalar` in Phase 2 of the rearchitecture so
