...
//!
//! This is `tasks/task-1816-rearchitecture-tdd.md`'s `rustdb-pool`, delivered in
//! Phase 2. It sits above `rustdb-vfs` and below `rustdb-tree`, and the page
//! primitives that Phase 1 put in `rustdb-tree::page` moved down here with it -
...
#![deny(clippy::panic)]
// As in `rustdb-tree`: `arithmetic_side_effects` is not denied here because a
