...
use rustdb_pool::interior::{InteriorBuilder, InteriorRef};
use rustdb_pool::page::{self, PageKind};
use rustdb_pool::{Database, PageGuard, PageId, Pool, Swip};
...
const RESTARTS: u32 = rustdb_pool::OPTIMISTIC_RETRIES;
...
mod tests {
    use super::*;
    use rustdb_pool::{Options, PageId};
