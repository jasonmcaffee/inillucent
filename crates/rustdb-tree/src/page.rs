...
//! workspace. Phase 1 put it here, because `rustdb-tree` was the lowest crate
//! that knew what a page was. Phase 2 introduced `rustdb-pool` *below* the tree
...
//!
//! Nothing else changed: `rustdb_tree::page::PageId`, `write_common`,
