...
fn main() {
    ...
    let mut out = String::new();
    out.push_str("// @generated from compat/errors.toml by crates/rustdb-base/build.rs.\n");
...
fn generate_limits(manifest_dir: &Path, out_dir: &Path) {
    ...
    let mut out = String::new();
    out.push_str("// @generated from compat/limits.toml by crates/rustdb-base/build.rs.\n");
    out.push_str("// Edit the manifest, not this file.\n\n");
