...
//!
//! `rustdb::Statement<'connection>` borrows the connection that prepared it. C
...
use rustdb::{Connection, Database, DbError, Statement, Value};
...
pub struct sqlite3_blob {
    ...
    pub(crate) blob: rustdb::Blob<'static>,
}
