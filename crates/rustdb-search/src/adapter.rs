...
//!
//! - `rustdb_core::index::Index`, below - the direct, in-process engine, whose
...
//!   does the same things to rows in a `rustdb_search` table.
//!
...
mod tests {
    use super::*;
    use rustdb_core::index::IndexConfig;
